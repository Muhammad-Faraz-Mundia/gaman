      ...
      <header class="sticky top-0 z-50 bg-white px-6">
        ...
        <!-- Social Nav -->
          <ul aria-label="social navbar" class="space-y-2.5 text-white">
            <li>
              <a target="_blank" href="https://www.linkedin.com/company/gaman-trading-wll/" class="flex size-10 items-center justify-center rounded-full border border-[#C0C1C1]" style="color:#002f99">
