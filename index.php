        ...
        <section class="relative z-0 w-full px-6 xl:h-[1040px] xl:px-12 home-hero-banner">
          <div class="mx-auto flex max-w-[1517px] flex-col xl:flex-row">
            ...
            <div class="w-full max-w-[600px] pr-12 pt-12 text-white md:pr-0 xl:pt-[298px]" style="z-index: 99;">
              <h1 class="mb-2 font-primary text-5xl font-semibold leading-[1.1] md:text-6xl mainHeading">Your Trusted Partner in Steel Products: Reliable, Durable, and Efficient Solutions</h1>
        ...
        <section class="px-6 pb-16 pt-12 md:pb-28 md:pt-[76px] fade-in-animation">
          <div class="mx-auto flex w-full max-w-[1000px] flex-col items-center gap-12 md:flex-row lg:gap-[76px]">
            ...
            <div class="order-first w-full max-w-[485px] md:order-none">
              ...
              <p class="mb-8 pl-1 text-lg leading-8 text-primary md:text-xl fade-in-animation">At Gaman, we are committed to being a trusted partner in the steel industry, delivering high-quality products and exceptional service. With extensive expertise and a focus on reliability, we provide tailored solutions, efficient logistics, and a dedication to excellence that supports our clients' requirements to achieve success.</p>
