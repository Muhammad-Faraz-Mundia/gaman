      ...
      <main class="overflow-hidden">
        ...
        <section class="px-6 pb-20 pt-20">
          ...
          <div class="mx-auto grid w-full max-w-[1290px] grid-cols-1 gap-y-16 md:grid-cols-2">
            <div class="relative z-0 self-center pr-4">
              <img src="assets/images/about-main.jpg" alt="About Us" class="h-auto w-full rounded-[30px] object-cover" />
